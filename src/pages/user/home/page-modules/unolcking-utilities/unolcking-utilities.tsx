    ...
    <div className='unlocking-utilities pt-5'>
      <div className='w90 max1000 pt-4'>
        ...
        <p className='text-center'>
          Through a solid alliance with our ecosystem development partners, Sinverse is giving a 
      ...
      <div className='rf-grid'>
        ...
        <div className='sale-info center-info center-mobile'>
          <div className='w90 max500 py-5'>
            <h6 className='increased-x mb-3'>
              Sinverse offers a practical application for digital assets, allowing for seamless payment of utility 
