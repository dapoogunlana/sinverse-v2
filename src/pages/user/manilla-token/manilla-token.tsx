        ...
        <div className='row'>
          ...
          <div className='col-md-6 center-info'>
            <div className='w90 center-mobile'>
              <p>
                MNLA is the token that powers the whole Sinverse ecosystem.. It’s the rocket fuel of the growing 
          ...
          <div className='row'>
            <div className='col-md-6 center-info'>
              <div className='w90 center-mobile'>
                ...
                <p className='pb-4 reduced-soft'>
                  - Share 30% of profit generated by Sinverse every fiscal year. This reward is distributed in USDT, 
                  USDC, BUSD or DAI <br />
                ...
                <p className='pb-4 reduced-soft'>
                  The information provided on the Sinverse website does not constitute investment advice, financial 
                  advice and trading advice. The Sinverse team does not recommend that any cryptocurrency should be 
