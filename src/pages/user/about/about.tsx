        ...
        <div className='w96 max1200'>
          <div className='sub-grid'>
            ...
            <div className='more-info'>
              <p>
                Sinverse adopts blockchain technology to build the next-generation financial ecosystem. We strive to 
            ...
            <div className='col-md-6 center-info'>
              <div className='w90 py-3'>
                ...
                <p className='center-mobile'>
                  Security is our top priority, first of all, with speed rallying along. Sinverse provides a safe, reliable, 
      ...
      <div className='team-sect py-5' id='our-people'>
        <div className='w96 max1200 py-5'>
          ...
          <p className='text-center'>
            ...
            pros are not less than a project like Sinverse would require. You just cannot get enough of their pro skills  
          </p>
          <div className='grid5'>
